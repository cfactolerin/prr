...
allowed-tools: ["Bash(${CLAUDE_PLUGIN_ROOT}/bin/prr-darwin-universal *)", "Bash(gh *)", "Bash(git *)", "Bash(cat *)", Read, Grep, Glob, Agent, TaskCreate, TaskUpdate, TaskList, AskUserQuestion]
---
